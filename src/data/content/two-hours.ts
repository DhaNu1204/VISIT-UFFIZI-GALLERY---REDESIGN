...
const en: TwoHoursContent = {
  ...
  practicalInfo: {
    ...
    paragraphs: [
      ...
      "**How to buy:** Book online at uffizi.it or through an independent local agency. Choose the 8:15 AM time slot for this 2-hour route. You'll receive a QR code by email — show it on your phone (or a printout). There is nothing to collect and no paper voucher to exchange.",
...
const it: TwoHoursContent = {
  ...
  practicalInfo: {
    ...
    paragraphs: [
      ...
      "**Come acquistare:** Prenotate online su uffizi.it o tramite un'agenzia locale indipendente. Scegliete la fascia delle 8:15 per questo percorso di 2 ore. Riceverete un codice QR via email — mostratelo dal telefono (o stampato). Non c'è nulla da ritirare e nessun voucher cartaceo da cambiare.",
...
const de: TwoHoursContent = {
  ...
  practicalInfo: {
    ...
    paragraphs: [
      ...
      "**Kaufen:** Online auf uffizi.it oder ueber eine unabhaengige lokale Agentur. Waehlen Sie das 8:15-Uhr-Zeitfenster fuer diesen 2-Stunden-Rundgang. Sie erhalten einen QR-Code per E-Mail — nichts abzuholen, kein Papiervoucher zum Umtauschen.",
